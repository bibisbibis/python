...
print(
  "Você precisa escolher uma posição no grid para marcar sua jogada, de acordo com a numeração"
)
print("_ _ _")
print("_ _ _")
print("_ _ _")
